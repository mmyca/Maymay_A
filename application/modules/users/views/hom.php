  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?= base_url('assets')?>/index3.html" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light">Mapping Integration of GIS and RBIS</span>
      </a>
      ...
      <ul class="order-1 order-md-3 navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="<?= base_url('users/logout/') ?>" class="dropdown-item dropdown-footer text-danger">
